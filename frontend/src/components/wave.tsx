...
export default function Strands({
  ...
  useEffect(() => {
    ...
    // Sin contexto WebGL, ogl lanza al construir el Renderer. Si esa excepción
    // sale del efecto, React desmonta el árbol entero y la página queda en
    // blanco: acá se contiene y el fondo estático de respaldo queda a la vista.
